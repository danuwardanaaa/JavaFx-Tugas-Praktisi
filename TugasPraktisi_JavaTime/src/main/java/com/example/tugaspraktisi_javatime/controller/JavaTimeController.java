package com.example.tugaspraktisi_javatime.controller;
...
public class JavaTimeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        localZone.getItems().addAll(localItems);
        timeZone.getItems().addAll(timeZoneItems);
        timeZone.setOnAction(this::dateDisplay);
        dateStyle.getItems().addAll(dateStyleItems);
        timeStyle.getItems().addAll(timeStyleItems);

    }

    public void dateDisplay(ActionEvent event){
        LocalDateTime ldt = LocalDateTime.now();
        String timeZoneChoice = timeZone.getValue();
        ZonedDateTime tanggal = ZonedDateTime.of(ldt,ZoneId.of(timeZoneChoice));

        String dateStyleChoice = dateStyle.getValue();
        String timeStyleChoice = timeStyle.getValue();
        DateTimeFormatter dateFormat;
            if (dateStyleChoice == "Short") {
                dateFormat = DateTimeFormatter.ofPattern("MMMM, yyyy");
            } else if (dateStyleChoice == "Medium") {
                dateFormat = DateTimeFormatter.ofPattern("MMMM dd, yyyy");
            } else {
                dateFormat = DateTimeFormatter.ofPattern("EE, MMMM dd, yyyy");
            }
        DateTimeFormatter timeFormat = DateTimeFormatter.ofPattern("hh:mm:ss");
        time.setText(String.valueOf(tanggal.format(timeFormat)));
        date.setText(String.valueOf(tanggal.format(dateFormat)));
    }
}